...
ActiveRecord::Schema.define(version: 2019_08_19_030320) do
  ...
  create_table "charts", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["asset_id"], name: "index_charts_on_asset_id"
  end
  ...
  create_table "logs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["asset_id"], name: "index_logs_on_asset_id"
  end
  ...
  add_foreign_key "charts", "assets"
  add_foreign_key "logs", "assets"
